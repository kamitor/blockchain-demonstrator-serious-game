...
{
    public class Processor : IRole
    {
        public Role Destination { get; set; } = Role.Manufacturer;
        public double LeadTime { get; set; } = 17;
        ...
        public Product Product { get; set; } = Product.Barley;
    }
}
